...
def main():
	...
	png_files = batch_search(project_path,  "Pods", ['.png', '.svga', '.gif', '.mp3', '.mp4'])
	check_files = batch_search(project_path, "Pods", ['.xib', '.storyboard', '.[mh]', '.pch', '.java', '.xml', '.m', '.mm', "plist", "swift", ".kt"])
	suffix1 = "@2x.png"
	suffix2 = ".9.png"
	suffix3 = ".png"
	suffix4 = "@3x.png"
